...
{
    private SanctumValidator $sanctumValidator;
    ...
    {
        $this->sanctumValidator->validateIssueTokenRequest($rawData);
        ...
        if (!$user || !Hash::check($data->getPassword(), $user->password)) {
            throw new BadRequestException("The provided credentials is not correct.");
        }
